...
/*  ==========================================================================
	...
	function navBtnClosedOver() {
		...
		navIconTL.set('.burger__stroke-over', { stroke: "#47C2BB", drawSVG: 0 })
	...
	function navBtnClosedOut() {
		...
		navIconTL.to('.burger__stroke-over', 0.4, { drawSVG: 0, ease: Power4.easeInOut })
				 .to('.burger__plus', 0.3, { fill: '#47C2BB', rotation: 0, ease: Power4.easeInOut }, 0);
	}
...
/*  ==========================================================================
	...
	function openNav() {
     ...
     $linkTitle.each(function(){
		 ...
		 newTxt+= '<div class="word" css="position:relative;display:inline-block;">'
		     for(j=0;j<word[i].length; j++){
	              newTxt+='<div class="titlemin" css="position:relative;display:inline-block;">'+word[i][j]+'</div>';
             }
